...
Islamic Companion is your all-in-one Islamic app for daily spiritual needs. Beautifully designed, lightweight, and available in 11 languages.

**PRAYER TIMES (NAMAZ VAKİTLERİ)**
Accurate prayer time calculations based on your location. Never miss a prayer with clear visual indicators for Fajr, Dhuhr, Asr, Maghrib, and Isha.

**QIBLA COMPASS (KIBLE YÖNÜ)**
Find the direction of the Kaaba from anywhere in the world with our elegant compass interface.

**DHIKR COUNTER (ZİKİRMATİK)**
Digital tasbih with haptic feedback. Choose from 8 different dhikr:
• SubhanAllah
• Alhamdulillah
• Allahu Akbar
• La ilaha illAllah
...
**DAILY DUAS**
Essential duas for daily life organized by category:
• Morning & Evening
• Before Sleep
• Before Eating
• Travel
...
## Pricing
Free (with optional ad-based Sadaqah)
